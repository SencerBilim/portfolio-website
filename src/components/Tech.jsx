import { BiLogoJavascript, BiLogoMongodb, BiLogoNodejs, BiLogoReact, BiLogoTailwindCss } from "react-icons/bi"
...
const Tech = () => {
  ...
  return (
    <div id="tech" className='flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32'>
      ...
      className="text-5xl font-light text-white md:text-4xl">{t("Tech")}</motion.h1>
