...
function Home() {
  return (
    <div className="relative min-h-screen w-full bg-slate-900">
      ...
      />
      <div className="absolute inset-1 z-10 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:74px_27px]" />
    </div>
  );
}
